...
public unsafe class CustomizeSightDistance : ModuleBase
{
    ...
    {
        cameraCollisionPatch = new(CameraCollisionBaseSig.Get(), [0x90, 0x90, 0xE9, 0xA7, 0x01, 0x00, 0x00, 0x90]);
    ...
    protected override void ConfigUI()
    {
        ...
        AddSlider
        (
            "CustomizeSightDistance-MaxDistanceInput",
            ref config.MaxDistance,
